  ...
  <el-card>
    ...
    <el-table border style="margin: 10px 0px;" :data="userArr">
      ...
      <el-table-column label="操作" width="300px" align="center">
        <template #="{ row }">
          <el-button type="primary" size="small" icon="UserFilled">分配角色</el-button>
          <el-button type="primary" size="small" icon="EditPen" @click="editUser(row)">编辑</el-button>
          <el-button type="primary" size="small" icon="DeleteFilled">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页器 -->

  ...
  <el-card>
    ...
    <el-table @selection-change="selectChange" border style="margin: 10px 0px" :data="userArr">
      ...
      <el-table-column label="操作" width="300px" align="center">
        <template #="{ row }">
          <el-button type="primary" size="small" icon="UserFilled" @click="setRole(row)">
            分配角色
          </el-button>
          <el-button type="primary" size="small" icon="EditPen" @click="editUser(row)">
            编辑
          </el-button>
    ...
    <div class="demo-pagination-block">
      <el-pagination @current-change="getHasUser" @size-change="handler" v-model:current-page="pageNo"
        v-model:page-size="pageSize" :page-sizes="[3, 7, 9, 12]" :background="true"
...
import { reqUserInfo, reqAddOrUpdateUser, reqAllRole, reqSetUserRole, reqDeleteUserRole, reqSelectUser } from '@/api/aci/user/index'
import { UserResponseData, Records, UserResponse, AllRoleResponseData, AllRole, SetRoleData } from '@/api/aci/user/type'

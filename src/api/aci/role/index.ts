...
export const reqRoleAllList = (
    page: number, limit: number, roleName: string
...
// 获取全部的全部菜单与按钮数据
export const reqAllTreeRoles = (roleId:number) => request.get<any,any>(API.ALLPERMISSTION_URL + roleId);
...
//   删除角色接口
export const reqReoveRole = (Id:number) => request.delete<any,any>(API.REMOVEROLE_URL + Id) 